...
module Psych
  ...
  def self.load(yaml, filename = nil, fallback: nil, symbolize_names: nil); end
  def self.load_file(filename, fallback: nil); end
  def self.load_stream(yaml, filename = nil); end
  def self.load_tags; end
  def self.load_tags=(arg0); end
  def self.parse(yaml, filename = nil, fallback: nil); end
  def self.parse_file(filename); end
  def self.parse_stream(yaml, filename = nil, &block); end
  def self.parser; end
  def self.remove_type(type_tag); end
  def self.safe_load(yaml, whitelist_classes = nil, whitelist_symbols = nil, aliases = nil, filename = nil, symbolize_names: nil); end
