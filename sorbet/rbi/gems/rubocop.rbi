...
class RuboCop::StringUtil::Jaro
  def compute_distance; end
  def compute_non_zero_distance(matched_count, transposition_count); end
  def count_transpositions(common_chars_a, common_chars_b); end
  def distance; end
  def find_common_characters; end
  def initialize(string_a, string_b); end
  def longer; end
  def matching_index_range(origin); end
  def matching_window; end
  def self.distance(*args); end
  def shorter; end
end
class RuboCop::StringUtil::JaroWinkler < RuboCop::StringUtil::Jaro
  def boost_threshold; end
  def common_prefix_length; end
  def compute_distance; end
  def initialize(string_a, string_b, boost_threshold = nil, scaling_factor = nil); end
  def limited_common_prefix_length; end
...
module RuboCop::AST::MethodDispatchNode
  ...
  def arguments; end
  def bare_access_modifier?(node = nil); end
...
module RuboCop::Cop::PercentLiteral
  ...
  def line_breaks(node, source, previous_line_number, base_line_number); end
...
class RuboCop::Cop::Layout::ClosingParenthesisIndentation < RuboCop::Cop::Cop
  ...
  def expected_column(node, elements); end
  def fixed_parameter_indentation?; end
...
class RuboCop::Cop::Layout::SpaceInsideReferenceBrackets < RuboCop::Cop::Cop
  ...
  def empty_config; end
  def left_ref_bracket(tokens); end
  def on_send(node); end
...
class RuboCop::Cop::Lint::IneffectiveAccessModifier < RuboCop::Cop::Cop
  def check_child_scope(node, cur_vis); end
  def check_defs(node, cur_vis); end
  def check_node(node); end
  def check_scope(node, cur_vis = nil); end
  def check_send(node, cur_vis); end
  def clear; end
  def format_message(visibility, modifier); end
  def mark_method_as_useless(node, cur_vis); end
  def on_class(node); end
  def on_module(node); end
  def private_class_method(node = nil); end
  def revert_method_uselessness(methods); end
end
...
class RuboCop::Cop::Performance::RegexpMatch < RuboCop::Cop::Cop
  ...
  def correct_operator(corrector, recv, arg); end
...
class RuboCop::Cop::Style::BracesAroundHashParameters < RuboCop::Cop::Cop
  ...
  def on_send(node); end
  def remove_braces(corrector, node); end
...
class RuboCop::Cop::Style::EmptyLineAfterGuardClause < RuboCop::Cop::Cop
  def autocorrect(node); end
  def contains_guard_clause?(node); end
  def next_line_empty?(node); end
...
class RuboCop::Cop::Style::MethodMissing < RuboCop::Cop::Cop
  def calls_super?(node); end
  def check(node); end
...
class RuboCop::Cop::Style::RedundantParentheses < RuboCop::Cop::Cop
  ...
  def first_argument?(node = nil); end
...
class RuboCop::Cop::Rails::InverseOf < RuboCop::Cop::Cop
  ...
  def class_name_option?(node = nil); end
...
class RuboCop::Cop::Rails::ReversibleMigration < RuboCop::Cop::Cop
  ...
  def within_reversible_block?(node); end
end
