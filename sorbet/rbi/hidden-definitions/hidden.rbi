...
module OpenGov::Util::Errors::HttpStatusError
  extend ::T::Sig
end

module OpenGov::Util::Errors
  extend ::T::Sig
end
...
class RSpec::Mocks::AnyInstance::StubChain
  ...
  InovcationOrder = ::T.let(nil, ::T.untyped)
end
...
module Rake::Cleaner
  ...
  extend ::FileUtils::StreamUtils_
  extend ::T::Sig
  def self.cleanup(file_name, opts=T.unsafe(nil)); end
...
class RuboCop::Cop::Style::EmptyLineAfterGuardClause
  MSG = ::T.let(nil, ::T.untyped)
end
